...
00104     \textcolor{stringliteral}{"MichaelJackson\_Beat\_It:d=4,o=5,b=138:g#7, p, d#6, d6, d#6, d6, c6, d6, d#6, d6, d#6, d6, d#6, d6, c6,
       ...
       16c, 16c, 16c, 1"},
00105     \textcolor{stringliteral}{"Michael Jackson - Thriller:d=31,o=5,b=112:24b., 15p, 16d.6, p, 24b., 15p, 9e.6, p, 2d.6, 3p, 9d.6, p,
       16c#.6, 10p, 6b., 3p, 24b., 15p, 16b., p, 49a., 10p, 16a., p, 49g., p, 9g., p, 24e., 15p, 12g., 153, 24a.,
       15p, 16b., p, 24a., 15p, 16a., p, 24g., 153, 16b., 1"}
00106 \};
00107 
\hypertarget{sensors_8c_source.tex_l00113}{}\hyperlink{sensors_8h_ac268bd7cd4a7f4825e597fb81dfd82f5}{00113} \textcolor{keywordtype}{char}* \hyperlink{sensors_8c_ac268bd7cd4a7f4825e597fb81dfd82f5}{randsong}() \{
00114     \textcolor{keywordtype}{int} index = rand() % \hyperlink{sensors_8h_ac3e33f0dc086adda988b210eacf86312}{SONG\_COUNT};
00115     \textcolor{keywordflow}{return} \hyperlink{sensors_8c_ad0bf4fe84ad2c452b03494aa89148939}{songs}[index];
00116 \}
00117 
\hypertarget{sensors_8c_source.tex_l00123}{}\hyperlink{sensors_8c_a29754c0d165c3e366278bf93ee231e35}{00123} TaskHandle \hyperlink{sensors_8c_a29754c0d165c3e366278bf93ee231e35}{speakerTask};
00124 
\hypertarget{sensors_8c_source.tex_l00131}{}\hyperlink{sensors_8h_a44ad7c17f20379371c31ec8ba82ff03e}{00131} \textcolor{keywordtype}{void} \hyperlink{sensors_8c_a44ad7c17f20379371c31ec8ba82ff03e}{playSpeaker}(\textcolor{keywordtype}{void} *ignore)\{
00132     \textcolor{keywordtype}{char} *rtttl = \hyperlink{sensors_8c_ac268bd7cd4a7f4825e597fb81dfd82f5}{randsong}();
00133     speakerPlayRtttl(rtttl);
00134     \hyperlink{sensors_8c_a29754c0d165c3e366278bf93ee231e35}{speakerTask} = NULL;
00135 \}
\end{DoxyCode}
