...
00075     \hyperlink{opcontrol_8c_aaefa47f4fdf865c2358c22b542a993e4}{turn} = error * \hyperlink{sensors_8h_a5caef30fe7ef36e6f497db8bf9fd9c67}{GYRO\_P};
00076 \}
00077 
...
00155     \textcolor{keywordtype}{bool} speakerPlay = \textcolor{keyword}{false};
00156     \textcolor{keywordtype}{bool} speakerButtonPressed = \textcolor{keyword}{false};
00157     \hyperlink{sensors_8c_a29754c0d165c3e366278bf93ee231e35}{speakerTask} = NULL;
00158     \textcolor{keywordflow}{while} (\textcolor{keyword}{true}) \{
00159         \textcolor{keywordflow}{if}(isOnline() || \hyperlink{autonrecorder_8c_aa2eda471576bdbaf33835a71da9bc616}{progSkills} == 0)\{
00160             \textcolor{keywordflow}{if}(joystickGetDigital(1, 8, JOY\_UP) || joystickGetDigital(1, 8, JOY\_DOWN)) \{
00161                 \textcolor{keywordflow}{if}(!speakerButtonPressed) \{
...
00189                     \hyperlink{autonrecorder_8c_af6d130061f44459f9b3c629123e78f6e}{loadAuton}();
00190                     \hyperlink{autonrecorder_8c_ae592a73a6bd9b2adcaa58a8ee82daaa0}{playbackAuton}();
00191                 \}
00192                 \hyperlink{opcontrol_8c_ad3b45c5807c039d0ce28bb0da06f0014}{moveRobot}();
00193             \}
00194         \} \textcolor{keywordflow}{else} \{
00195             motorStopAll();
00196             lcdSetText(\hyperlink{lcdmsg_8h_abcf42bd88b3c36193f301ca25b033875}{LCD\_PORT}, 1, \textcolor{stringliteral}{"Press 7R"});
00197             lcdPrint(\hyperlink{lcdmsg_8h_abcf42bd88b3c36193f301ca25b033875}{LCD\_PORT}, 2,   \textcolor{stringliteral}{"Last Skills: %d"}, \hyperlink{autonrecorder_8c_aa2eda471576bdbaf33835a71da9bc616}{progSkills});
00198             \textcolor{keywordflow}{if} (joystickGetDigital(1, 7, JOY\_RIGHT) && !isOnline()) \{
00199                 \hyperlink{autonrecorder_8c_a1611f78b8c904848dcc98ae4b0b5b22b}{recordAuton}();
00200                 \hyperlink{autonrecorder_8c_ae6b758086a3b984c6705e12859eed2cc}{saveAuton}();
00201             \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(joystickGetDigital(1, 7, JOY\_UP) && !isOnline()) \{
00202                 \hyperlink{autonrecorder_8c_aa2eda471576bdbaf33835a71da9bc616}{progSkills} = 0;
00203             \}
00204         \}
00205         delay(20);
00206     \}
