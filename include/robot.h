/** @file robot.h
 * @brief File for robot constant definitions
 *
 * This file contains definitions for constants regarding the robot.
 * These definitions pertain to physical properties of the robot.
 */
#ifndef ROBOT_H_
#define ROBOT_H_
